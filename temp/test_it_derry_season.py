"""Test extracting all episodes from It Welcome to Derry season"""
import sys
import os
import json
import logging
...
season_url = "https://x7k9f.sbs/season/it-welcome-to-derry-25/"

scraper = EgyDeadScraper()

try:
    print("="*70)
    print("Extracting All Episodes from It Welcome to Derry")
    print("="*70)
    ...
    # Save results
    output_file = 'it_derry_results.json'
