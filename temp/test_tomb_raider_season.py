"""Test extracting all episodes from Tomb Raider season 2"""
import sys
import os
import json
import logging
...
season_url = "https://x7k9f.sbs/season/tomb-raider-the-legend-of-lara-croft-s02/"

scraper = EgyDeadScraper()

try:
    print("="*70)
    print("Extracting All Episodes from Tomb Raider Season 2")
    print("="*70)
        ...
        try:
            ...
            if result:
                ...
                if multi_sources:
                    ...
                    for ms in multi_sources:
                        print(f"     - {ms.get('server')} ({ms.get('quality')})")
    ...
    # Save results
    output_file = 'tomb_raider_s02_results.json'
